...
export function scoreSlashCommand(command: HermesSlashCommand, needle: string) {
...
export function slashCommandTokenIsPartial(input: string, token: SlashToken, command: HermesSlashCommand) {
