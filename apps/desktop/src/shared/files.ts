...
export function isImagePath(path: string) {
  return attachmentKindFromPath(path) === "image";
}
...
export function attachmentKindFromPath(path: string): AttachmentKind {
  return attachmentKindFromMime(mimeTypeFromPath(path), path);
}

export function isPreviewableImage(mimeType: string, filename = "") {
  return attachmentKindFromMime(mimeType, filename) === "image" && !normalizeMimeType(mimeType).includes("svg");
}
...
const DOCUMENT_EXTENSIONS = new Set([
  "pdf", "doc", "docx", "xls", "xlsx", "ppt", "pptx", "odt", "ods", "odp", "rtf", "csv", "epub", "html", "htm", "json", "xml",
]);
...
const CODE_EXTENSIONS = new Set([
  "md", "markdown", "txt", "yaml", "yml", "toml", "js", "jsx", "ts", "tsx", "py", "rb", "go", "rs", "java", "c", "h", "cpp", "cc", "css", "sh",
]);
