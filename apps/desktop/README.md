...
Use `npm run build:mac:app:universal` from the repository root for a universal macOS bundle after staging both native macOS Iris Core sidecars in `src-tauri/binaries`. Release CI builds and stages those sidecars automatically.
