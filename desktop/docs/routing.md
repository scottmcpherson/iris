...
Future mobile shells should reuse `desktop/src/app/routing/routeIntent.ts` for string parsing and intent serialization. Register both a custom scheme (`iris://...`) and universal/app links under `https://iris.app/open/...`.
